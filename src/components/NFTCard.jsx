...
const NFTCard = ({ item, showExpiry = true }) => {
  ...
  return (
    <div className="nft__item">
      ...
      {/* Conditionally render the countdown timer if showExpiry is true */}
      {showExpiry && <div className="de_countdown">{timeRemaining}</div>}
...
NFTCard.propTypes = {
  ...
  showExpiry: PropTypes.bool, // Optional prop to control whether expiry timer is shown
};
